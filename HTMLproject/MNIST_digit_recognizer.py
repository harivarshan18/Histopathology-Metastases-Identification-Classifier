...
def h(X,W,b):
    ...
    Layer 1: input, Layer 2: hidden layer, with a size implied by the arguments W[0], b, Layer 3: output layer, with a size implied by the arguments W[1]
    '''
    # layer 1 = input layer
    a1 = X
...
def backprop(W,b,X,y,alpha=1e-4):
    '''
    Step 1: explicit forward pass h(X;W,b), Step 2: backpropagation for dW and db
    '''
    K = 10
    N = X.shape[0]
